...
#define STRING_CONFIG_H_AUTHOR "(Sebastian, TAZ)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,1600,801}  // default steps per unit for TAZ
...
#define PETG_PREHEAT_HPB_TEMP 80

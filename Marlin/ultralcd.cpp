...
int petgPreheatHotendTemp;
int petgPreheatHPBTemp;
int petgPreheatFanSpeed;
...
static void lcd_status_screen();
  ...
  static void lcd_control_temperature_preheat_petg_settings_menu();
...
void _lcd_preheat(int endnum, const float temph, const float tempb, const int fan) {
  ...
  void lcd_preheat_petg0() { _lcd_preheat(0, petgPreheatHotendTemp, petgPreheatHPBTemp, petgPreheatFanSpeed); }
  void lcd_preheat_abs0() { _lcd_preheat(0, absPreheatHotendTemp, absPreheatHPBTemp, absPreheatFanSpeed); }
#endif

#if EXTRUDERS > 1
  void lcd_preheat_pla1() { _lcd_preheat(1, plaPreheatHotendTemp, plaPreheatHPBTemp, plaPreheatFanSpeed); }
  void lcd_preheat_petg1() { _lcd_preheat(1, petgPreheatHotendTemp, petgPreheatHPBTemp, petgPreheatFanSpeed); }
  void lcd_preheat_abs1() { _lcd_preheat(1, absPreheatHotendTemp, absPreheatHPBTemp, absPreheatFanSpeed); }
  #if EXTRUDERS > 2
    void lcd_preheat_pla2() { _lcd_preheat(2, plaPreheatHotendTemp, plaPreheatHPBTemp, plaPreheatFanSpeed); }
    void lcd_preheat_petg2() { _lcd_preheat(2, petgPreheatHotendTemp, petgPreheatHPBTemp, petgPreheatFanSpeed); }
    void lcd_preheat_abs2() { _lcd_preheat(2, absPreheatHotendTemp, absPreheatHPBTemp, absPreheatFanSpeed); }
    #if EXTRUDERS > 3
      void lcd_preheat_pla3() { _lcd_preheat(3, plaPreheatHotendTemp, plaPreheatHPBTemp, plaPreheatFanSpeed); }
      void lcd_preheat_petg3() { _lcd_preheat(3, petgPreheatHotendTemp, petgPreheatHPBTemp, petgPreheatFanSpeed); }
  ...
  void lcd_preheat_petg0123() {
    setTargetHotend0(petgPreheatHotendTemp);
    setTargetHotend1(petgPreheatHotendTemp);
    setTargetHotend2(petgPreheatHotendTemp);
    _lcd_preheat(3, petgPreheatHotendTemp, petgPreheatHPBTemp, petgPreheatFanSpeed);
  }
  ...
  void lcd_preheat_petg_bedonly() { _lcd_preheat(0, 0, petgPreheatHPBTemp, petgPreheatFanSpeed); }
  ...
  static void lcd_preheat_petg_menu() {
    START_MENU();
    MENU_ITEM(back, MSG_PREPARE, lcd_prepare_menu);
    #if EXTRUDERS == 1
      MENU_ITEM(function, MSG_PREHEAT_PETG, lcd_preheat_pla0);
    #else
      MENU_ITEM(function, MSG_PREHEAT_PETG_N MSG_H1, lcd_preheat_petg0);
      MENU_ITEM(function, MSG_PREHEAT_PETG_N MSG_H2, lcd_preheat_petg1);
      #if EXTRUDERS > 2
        MENU_ITEM(function, MSG_PREHEAT_PETG_N MSG_H3, lcd_preheat_petg2);
        #if EXTRUDERS > 3
          MENU_ITEM(function, MSG_PREHEAT_PETG_N MSG_H4, lcd_preheat_petg3);
        #endif
      #endif
      MENU_ITEM(function, MSG_PREHEAT_PETG_ALL, lcd_preheat_petg0123);
    #endif
    #if TEMP_SENSOR_BED != 0
      MENU_ITEM(function, MSG_PREHEAT_PETG_BEDONLY, lcd_preheat_petg_bedonly);
    #endif
    END_MENU();
  }
...
static void lcd_prepare_menu() {
  ...
  //
      ...
      MENU_ITEM(submenu, MSG_PREHEAT_PETG, lcd_preheat_petg_menu);
      MENU_ITEM(submenu, MSG_PREHEAT_ABS, lcd_preheat_abs_menu);
    #else
      MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla0);
      MENU_ITEM(function, MSG_PREHEAT_PETG, lcd_preheat_petg0);
      MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs0);
    #endif
  #endif
...
static void lcd_control_temperature_menu() {
  ...
  // Preheat PETG conf
  //
  MENU_ITEM(submenu, MSG_PREHEAT_PETG_SETTINGS, lcd_control_temperature_preheat_petg_settings_menu);
...
/**
 *
 * "Temperature" > "Preheat PETG conf" submenu
 *
 */
static void lcd_control_temperature_preheat_petg_settings_menu() {
  START_MENU();
  MENU_ITEM(back, MSG_TEMPERATURE, lcd_control_temperature_menu);
  MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &petgPreheatFanSpeed, 0, 255);
  #if TEMP_SENSOR_0 != 0
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &petgPreheatHotendTemp, HEATER_0_MINTEMP, HEATER_0_MAXTEMP - 15);
  #endif
  #if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &petgPreheatHPBTemp, BED_MINTEMP, BED_MAXTEMP - 15);
  #endif
  #if ENABLED(EEPROM_SETTINGS)
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
  #endif

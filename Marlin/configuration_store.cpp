 ...
 *  M145 S1 H petgPreheatHotendTemp
 *  M145 S1 B petgPreheatHPBTemp
 *  M145 S1 F petgPreheatFanSpeed
 *  M145 S2 H absPreheatHotendTemp
 *  M145 S2 B absPreheatHPBTemp
 *  M145 S2 F absPreheatFanSpeed
 *
 * PIDTEMP:
...
void Config_StoreSettings()  {
  ...
  EEPROM_WRITE_VAR(i, zprobe_zoffset);
    ...
    int plaPreheatHotendTemp = PLA_PREHEAT_HOTEND_TEMP, plaPreheatHPBTemp = PLA_PREHEAT_HPB_TEMP, plaPreheatFanSpeed = PLA_PREHEAT_FAN_SPEED,
        petgPreheatHotendTemp = PETG_PREHEAT_HOTEND_TEMP, petgPreheatHPBTemp = PETG_PREHEAT_HPB_TEMP, petgPreheatFanSpeed = PETG_PREHEAT_FAN_SPEED,
  ...
  EEPROM_WRITE_VAR(i, petgPreheatHotendTemp);
  EEPROM_WRITE_VAR(i, petgPreheatHPBTemp);
  EEPROM_WRITE_VAR(i, petgPreheatFanSpeed);
...
void Config_RetrieveSettings() {
  ...
  if (strncmp(ver, stored_ver, 3) != 0) {
    ...
    EEPROM_READ_VAR(i, petgPreheatHotendTemp);
    EEPROM_READ_VAR(i, petgPreheatHPBTemp);
    EEPROM_READ_VAR(i, petgPreheatFanSpeed);
...
void Config_ResetDefault() {
  ...
  home_offset[X_AXIS] = home_offset[Y_AXIS] = home_offset[Z_AXIS] = 0;
    ...
    petgPreheatHotendTemp = PETG_PREHEAT_HOTEND_TEMP;
    petgPreheatHPBTemp = PETG_PREHEAT_HPB_TEMP;
    petgPreheatFanSpeed = PETG_PREHEAT_FAN_SPEED;
...
void Config_PrintSettings(bool forReplay) {
  ...
  SERIAL_EOL;
    ...
    SERIAL_EOL;
    CONFIG_ECHO_START;
    SERIAL_ECHOPAIR("  M145 M1 H", (unsigned long)petgPreheatHotendTemp);
    SERIAL_ECHOPAIR(" B", (unsigned long)petgPreheatHPBTemp);
    SERIAL_ECHOPAIR(" F", (unsigned long)petgPreheatFanSpeed);
    SERIAL_EOL;
    CONFIG_ECHO_START;
    SERIAL_ECHOPAIR("  M145 M2 H", (unsigned long)absPreheatHotendTemp);
